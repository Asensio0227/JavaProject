...
const menuButtons = () => {
  const categories = menu.reduce((value, venom) => {
    if (!value.includes(venom.category)) {
      value.push(venom.category)
    }
    return value;
  }, ["all"])
  ...
  filerBtn.forEach((btn) => {
    btn.addEventListener('click', (e) => {
      ...
      const categoryBtns = menu.filter((menuItems) => {
